...
function requestAxies() {
    let promise = new Promise(function (resolve, reject) {
        ...
        URL = 'https://axieinfinity.com/marketplace-api/query-assets?sorting=recently_listed';
        let offset = '&offset=0';
        ...
        axios.get(URL + offset)
            .then(response => {
                ...
                axiesDataArr = axiesDataObj['data']['results'];
                console.log(axiesDataObj)
                console.log(axiesDataArr)
                resolve();
            })
            .catch(error => {
                console.log(error);
...
function getAllPagesToArray() {
    let promise = new Promise(async function (resolve, reject) {
        ...
        if (axiesDataObj['data']['total'] > axiesPerPage) {
